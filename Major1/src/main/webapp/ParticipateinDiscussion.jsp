    ...
    <div class="container">
        ...
        <form action="SendMessageServlet" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="discussionId" required>
                    <%
        ...
        <div class="messages">
            ...
            <%
                // Fetch messages related to selected discussion
                int selectedDiscussionId = request.getParameter("discussionId") != null 
                                           ? Integer.parseInt(request.getParameter("discussionId")) 
                                           : 0;
