        ...
        <table>
            ...
            <%
                ...
                try {
                    ...
                    // Query to fetch submissions that haven't been graded yet
                    String sql = "SELECT s.SID, s.AssignmentID, s.FilePath " +
                                 "FROM Submissions s " +
                                 "JOIN Assignments a ON s.AssignmentID = a.AssignmentID " +
                                 "JOIN Courses c ON a.CourseID = c.CourseID " +
                                 "WHERE c.TID = ? AND NOT EXISTS ( " +
                                 "  SELECT 1 FROM Grades g WHERE g.SID = s.SID AND g.AssignmentID = s.AssignmentID " +
                                 ")";
